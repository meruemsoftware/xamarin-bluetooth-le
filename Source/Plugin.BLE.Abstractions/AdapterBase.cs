...
namespace Plugin.BLE.Abstractions
{
    public abstract class AdapterBase : IAdapter
    {
        ...
        public async Task StartScanningForDevicesAsync(Guid[] serviceUuids = null, string[] deviceNames = null, Func<IDevice, bool> deviceFilter = null, bool allowDuplicatesKey = false, CancellationToken cancellationToken = default)
        {
            if (IsScanning)
            {
            ...
            try
            {
                ...
                {
                    await StartScanningForDevicesNativeAsync(serviceUuids, deviceNames, allowDuplicatesKey, _scanCancellationTokenSource.Token);
        ...
        protected abstract Task StartScanningForDevicesNativeAsync(Guid[] serviceUuids, string[] deviceNames, bool allowDuplicatesKey, CancellationToken scanCancellationToken);
