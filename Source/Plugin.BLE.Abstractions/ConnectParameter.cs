namespace Plugin.BLE.Abstractions
{
    ...
    public struct ConnectParameters
    {
        ...
        /// <summary>
        /// Create bond with device. The default is false
        /// </summary>
        public bool BondDevice { get; }
        ...
        /// <param name="bondDevice">Create bond with device. The default is false.</param>
        public ConnectParameters(bool autoConnect = false, bool forceBleTransport = false, bool bondDevice = false)
        {
